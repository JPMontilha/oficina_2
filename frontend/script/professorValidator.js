document.addEventListener('DOMContentLoaded', function() {
    ...
    // ==============================================
    // Modal de Gerenciamento de Oficinas
    // ==============================================
    ...
    if (manageModal) {
        document.querySelector("#manage-modal .close-modal").addEventListener("click", function() {
    ...
    // ==============================================
    // Funcionalidades da Aba "Alunos Inscritos"
    // ==============================================
    function loadWorkshopStudents(workshopName) {
        ...
        const students = [
            ...
            { nome: "Pedro Santos", codigo: "AL2025002", email: "pedro.santos@escola.edu" }
        ];
        ...
        document.querySelectorAll("#students-list .btn-danger").forEach(btn => {
            btn.addEventListener("click", function() {
                ...
                if (confirm(`Tem certeza que deseja remover ${studentName} da oficina?`)) {
                    this.closest("tr").remove();
                    // Aqui você faria uma requisição AJAX para remover o aluno
    ...
    // ==============================================
    // Funcionalidades da Aba "Adicionar Alunos"
    // ==============================================
    function loadAvailableStudents(workshopName) {
        // Simulação de dados - na prática, você faria uma requisição AJAX
        const students = [
            { nome: "Marina Oliveira", codigo: "AL2025003", email: "marina.oliveira@escola.edu" },
            { nome: "Carlos Mendes", codigo: "AL2025004", email: "carlos.mendes@escola.edu" },
            { nome: "Juliana Costa", codigo: "AL2025005", email: "juliana.costa@escola.edu" }
        ];
        ...
        document.querySelectorAll("#available-students .btn-success").forEach(btn => {
            btn.addEventListener("click", function() {
                const row = this.closest("tr");
                ...
                if (confirm(`Adicionar ${studentName} à oficina?`)) {
                    // Simular adição (na prática seria uma requisição AJAX)
    ...
    function showManageSuccess(message) {
        // Criar uma mensagem temporária no modal de gerenciamento
